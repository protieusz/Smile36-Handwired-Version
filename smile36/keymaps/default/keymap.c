...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        KC_BTN3, KC_BTN2, KC_BTN1, _______, _______, KC_TILD, KC_GRV,  _______, _______, KC_BSLS,
    ...
    [2] = LAYOUT(
        ...
        _______, _______, KC_MUTE, KC_VOLU, KC_VOLD, RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI,
        _______, _______, _______,                          _______, _______, _______
